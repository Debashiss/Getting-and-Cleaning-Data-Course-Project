...
## Packages Installed (Libraries Included)
...
This codebook provides descriptions of the variables, the data, and all transformations and work that I performed to clean up the data.
